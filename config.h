...
static const char *fonts[]          = { "IBM Plex Mono Medium:size=14" };
static const char dmenufont[]       = "IBM Plex Mono Medium:size=14";
...
static const char *sleepcmd[] = { "zzz", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_d,      spawn,          {.v = dmenucmd } },
	{ MODKEY,                       XK_Return, spawn,          {.v = termcmd } },
	{ Mod1Mask|ControlMask,         XK_q,      spawn,          {.v = sleepcmd } },
